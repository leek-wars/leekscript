...
public class Box {
	...
	public Object add_eq(Object val) throws LeekRunException {
		if (mValue instanceof LegacyHybridContainerLeekValue && !(val instanceof String)) {
	...
	public Object put(AI ai, Object key, Object value) throws LeekRunException {
		if (mValue instanceof LegacyHybridContainerLeekValue) {
			return ((LegacyHybridContainerLeekValue) mValue).put(ai, key, value);
		}
		throw new LeekRunException(Error.UNKNOWN_FIELD);
	}
