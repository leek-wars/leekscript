...
public class Box {
	...
	public Object add_eq(Object val) throws LeekRunException {
		if (mValue instanceof HybridContainerLeekValue && !(val instanceof String)) {
	...
	public Object put(AI ai, Object key, Object value) throws LeekRunException {
		if (mValue instanceof HybridContainerLeekValue) {
			return ((HybridContainerLeekValue) mValue).put(ai, key, value);
		}
		throw new LeekRunException(Error.UNKNOWN_FIELD);
	}
