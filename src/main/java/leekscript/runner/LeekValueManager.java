...
public class LeekValueManager {
	...
	public static int getType(Object v) {
		...
		if (v instanceof LegacyHybridContainerLeekValue || v instanceof ArrayLeekValue) return LeekValue.ARRAY;
	...
	public static int getV1Type(Object v) {
		...
		if (v instanceof LegacyHybridContainerLeekValue) return LeekValue.ARRAY_V1;
