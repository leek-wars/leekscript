...
public class Operators {
	...
	public final static int COLON = 27;
	...
	public final static int getOperator(String operator, int version) {
		...
		if (operator.equals(">>>="))
			return SHIFT_UNSIGNED_RIGHT_ASSIGN;
		if (operator.equals("@"))
			return REFERENCE;
