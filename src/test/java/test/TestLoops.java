...
public class TestLoops extends TestCommon {
	...
	@Test
	public void testWhile_loops() throws Exception {
		section("While loops");
	...
	@Test
	public void testDouble_while_loops() throws Exception {
	...
	@Test
	public void testDo_while() throws Exception {
		section("Do while");
	...
	@Test
	public void testDo_while_without_semicolon() throws Exception {
	...
	@Test
	public void testFor_variable_defined_before_the_loop() throws Exception {
	...
	@Test
	public void testFor_whitout_braces() throws Exception {
		section("For whitout braces");
		code("var s = 0 for (var i = 0; i < 10; i++) s += i return s;").equals("45");
	}

	@Test
	public void testFor_loops_with_returns() throws Exception {
	...
	@Test
	public void testNested_for_loops() throws Exception {
		...
		code_v4_("var tabmulti=[[:],[:],[:],[:],[:]]; var vPM=2; for(var i=0;i<=vPM;i++){ for(var j=-vPM;j<=vPM;j++){ tabmulti[i][j]=i*j;}} return tabmulti").equals("[[-2 : 0, -1 : 0, 0 : 0, 1 : 0, 2 : 0], [-2 : -2, -1 : -1, 0 : 0, 1 : 1, 2 : 2], [-2 : -4, -1 : -2, 0 : 0, 1 : 2, 2 : 4], [:], [:]]");
		code_strict_v4_("any tabmulti=[[:],[:],[:],[:],[:]]; var vPM=2; for(var i=0;i<=vPM;i++){ for(var j=-vPM;j<=vPM;j++){ tabmulti[i][j]=i*j;}} return tabmulti").equals("[[-2 : 0, -1 : 0, 0 : 0, 1 : 0, 2 : 0], [-2 : -2, -1 : -1, 0 : 0, 1 : 1, 2 : 2], [-2 : -4, -1 : -2, 0 : 0, 1 : 2, 2 : 4], [:], [:]]");
		...
		code_v4_("var tabmulti=[[:],[:],[:],[:],[:]]; var vPM=3; for(var i=0;i<=vPM;i++){ for(var j=-vPM;j<=vPM;j++){ tabmulti[i][j]=i*j;}} return tabmulti").equals("[[-3 : 0, -2 : 0, -1 : 0, 0 : 0, 1 : 0, 2 : 0, 3 : 0], [-3 : -3, -2 : -2, -1 : -1, 0 : 0, 1 : 1, 2 : 2, 3 : 3], [-3 : -6, -2 : -4, -1 : -2, 0 : 0, 1 : 2, 2 : 4, 3 : 6], [-3 : -9, -2 : -6, -1 : -3, 0 : 0, 1 : 3, 2 : 6, 3 : 9], [:]]");
		code_strict_v4_("any tabmulti=[[:],[:],[:],[:],[:]]; var vPM=3; for(var i=0;i<=vPM;i++){ for(var j=-vPM;j<=vPM;j++){ tabmulti[i][j]=i*j;}} return tabmulti").equals("[[-3 : 0, -2 : 0, -1 : 0, 0 : 0, 1 : 0, 2 : 0, 3 : 0], [-3 : -3, -2 : -2, -1 : -1, 0 : 0, 1 : 1, 2 : 2, 3 : 3], [-3 : -6, -2 : -4, -1 : -2, 0 : 0, 1 : 2, 2 : 4, 3 : 6], [-3 : -9, -2 : -6, -1 : -3, 0 : 0, 1 : 3, 2 : 6, 3 : 9], [:]]");
		...
		code_v4_("var tabmulti=[[:],[:],[:],[:],[:]]; var vPM=4; for(var i=0;i<=vPM;i++){ for(var j=-vPM;j<=vPM;j++){ tabmulti[i][j]=i*j;}} return tabmulti").equals("[[-4 : 0, -3 : 0, -2 : 0, -1 : 0, 0 : 0, 1 : 0, 2 : 0, 3 : 0, 4 : 0], [-4 : -4, -3 : -3, -2 : -2, -1 : -1, 0 : 0, 1 : 1, 2 : 2, 3 : 3, 4 : 4], [-4 : -8, -3 : -6, -2 : -4, -1 : -2, 0 : 0, 1 : 2, 2 : 4, 3 : 6, 4 : 8], [-4 : -12, -3 : -9, -2 : -6, -1 : -3, 0 : 0, 1 : 3, 2 : 6, 3 : 9, 4 : 12], [-4 : -16, -3 : -12, -2 : -8, -1 : -4, 0 : 0, 1 : 4, 2 : 8, 3 : 12, 4 : 16]]");
		code_strict_v4_("any tabmulti=[[:],[:],[:],[:],[:]]; var vPM=4; for(var i=0;i<=vPM;i++){ for(var j=-vPM;j<=vPM;j++){ tabmulti[i][j]=i*j;}} return tabmulti").equals("[[-4 : 0, -3 : 0, -2 : 0, -1 : 0, 0 : 0, 1 : 0, 2 : 0, 3 : 0, 4 : 0], [-4 : -4, -3 : -3, -2 : -2, -1 : -1, 0 : 0, 1 : 1, 2 : 2, 3 : 3, 4 : 4], [-4 : -8, -3 : -6, -2 : -4, -1 : -2, 0 : 0, 1 : 2, 2 : 4, 3 : 6, 4 : 8], [-4 : -12, -3 : -9, -2 : -6, -1 : -3, 0 : 0, 1 : 3, 2 : 6, 3 : 9, 4 : 12], [-4 : -16, -3 : -12, -2 : -8, -1 : -4, 0 : 0, 1 : 4, 2 : 8, 3 : 12, 4 : 16]]");
	}

	@Test
	public void testMix_for_and_while_loops() throws Exception {
	...
	@Test
	public void testEmpty_containers() throws Exception {
	...
	@Test
	public void testNormal_containers() throws Exception {
	...
	@Test
	public void testForeach_Minus_no_braces() throws Exception {
		section("Foreach - no braces");
		code("var s = 0 for (var v in [1, 2, 3, 4]) s += v return s;").equals("10");
	}

	@Test
	public void testForeach_Minus_double() throws Exception {
	...
	@Test
	public void testForeach_Minus_mix() throws Exception {
		section("Foreach - mix");
		// code("var n = 3 while (n--) { var r = [] for x in [1, 2, 3] { r += x } print(r) }").output("[1, 2, 3]\n[1, 2, 3]\n[1, 2, 3]\n");
	}

	@Test
	public void testForeach_Minus_references() throws Exception {
	...
	@Test
	public void testForeach_Minus_captures() throws Exception {
	...
	@Test
	public void testForeach_Minus_return() throws Exception {
