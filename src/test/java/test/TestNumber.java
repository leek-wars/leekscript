...
public class TestNumber extends TestCommon {
	...
	public void run() throws Exception {
		...
		code_v10("return 15 / 3;").equals("5");
		code_v11("return 15 / 3;").equals("5.0");
		code_v10("return 15 / 2;").equals("7,5");
		code_v11("return 15 / 2;").equals("7.5");
		...
		code_v10("var a = 100 return a /= 5;").equals("20");
		code_v11("var a = 100 return a /= 5;").equals("20.0");
		...
		code_v10("return (33 - 2) / 2;").equals("15,5");
		code_v11("return (33 - 2) / 2;").equals("15.5");
		...
		code_v10("return 13 / true;").equals("13");
		code_v11("return 13 / true;").equals("13.0");
		code_v10("return 14 / 2;").equals("7");
		code_v11("return 14 / 2;").equals("7.0");
		code_v10("var a = 18; return a / 3;").equals("6");
		code_v11("var a = 18; return a / 3;").equals("6.0");
		// code("14$ / []").exception(ls::vm::Exception::NO_SUCH_OPERATOR);
		code_v10("var a = 17, b = 5 return a / b;").equals("3,4");
		code_v11("var a = 17, b = 5 return a / b;").equals("3.4");

		section("Number.operator /=");
		code_v10("var a = 12 a /= 3 return a;").equals("4");
		code_v11("var a = 12 a /= 3 return a;").equals("4.0");
		code_v10("var a = 12 a /= 0.5 return a;").equals("24");
		code_v11("var a = 12 a /= 0.5 return a;").equals("24.0");
		code_v10("var a = 12 a /= true return a;").equals("12");
		code_v11("var a = 12 a /= true return a;").equals("12.0");
		code_v10("var a = null a /= 5 return a;").equals("0");
		code_v11("var a = null a /= 5 return a;").equals("0.0");
		...
		code_v10("var a = 15; return ['', a /= 2];").equals("[, 7,5]");
		code_v11("var a = 15; return ['', a /= 2];").equals("[, 7.5]");
		...
		code_v10("var a = 5 a ^= 2 return a;").equals("25"); // In LS 1.0, ^= was power equals
		code_v11("var a = 87619 return a ^= 18431;").equals("70076");
		code_v11("var a = 87619 a ^= 18431 return a;").equals("70076");
		...
		*/
		...
		code_v10("return abs(-19.5);").equals("19,5");
		code_v11("return abs(-19.5);").equals("19.5");
		code("return abs(12);").equals("12");
		// code("return abs(-16436435l)").equals("16436435");
		code_v10("return abs(-12.67);").equals("12,67");
		code_v11("return abs(-12.67);").equals("12.67");
		...
		section("Number.exp()");
		code_v10("return exp(0)").equals("1");
		code_v11("return exp(0)").equals("1.0");
		code_v10("return exp(1)").equals("2,718");
		code_v11("return exp(1)").almost(Math.E);
		code_v10("return exp(4)").equals("54,598");
		code_v11("return exp(4)").almost(54.598150033144236204);
		code_v10("return exp(4.89)").equals("132,954");
		...
		code_v10("return E ** 5;").equals("148,413");
		code_v11("return E ** 5;").almost(148.413159102576571513);
		...
		code("return max(5.0, 12);").equals("12.0");
		code("return max(75.7, 12);").almost(75.7);
		code("return max(5, 12.451);").almost(12.451);
		...
		code("return max(5, 12.8);").equals("12.8");
		code("return max(15.7, 12.8);").equals("15.7");
		code("return max([15.7, ''][0], 12.8);").equals("15.7");
		code("return max(5.5, [12.8, ''][0]);").equals("12.8");
		...
		code("return min(75.7, 12)").almost(12.0);
		code("return min(5, 12.451)").almost(5.0);
		...
		code("return min(5, 12.8)").equals("5.0");
		code("return min(15.7, 12.8)").equals("12.8");
		code("return min([15.7, ''][0], 12.8)").equals("12.8");
		code("return min(5.5, [12.8, ''][0])").equals("5.5");
		...
		section("Number.cos()");
		code("return cos(0)").equals("1.0");
		code("return cos(2.5)").almost(Math.cos(2.5));
		code("return cos(PI)").equals("-1.0");
		code("return cos(PI / 2)").almost(0.0);
		// code("return π.cos()").equals("-1");
		// code("return ['', π][1].cos()").equals("-1");
		code("return cos(['', PI][1]);").equals("-1.0");
		code("return cos(PI);").equals("-1.0");

		section("Number.acos()");
		code("return acos(1)").equals("0.0");
		code("return acos(-1)").almost(Math.PI);
		code("return acos(0)").almost(Math.PI / 2);
		// code("return (-0.33).acos()").almost(1.907099901948877019);
		code("return acos(['y', 0][1])").almost(Math.PI / 2);

		section("Number.sin()");
		code("return sin(0)").equals("0.0");
		code("return sin(2.5)").almost(Math.sin(2.5));
		code("return sin(PI)").almost(0.0);
		code("return sin(PI / 2)").equals("1.0");
		code("return sin(- PI / 2)").equals("-1.0");
		code("return sin(['', PI / 2][1])").equals("1.0");
		code("return sin(PI / 2)").equals("1.0");

		section("Number.tan()");
		code("return tan(0)").equals("0.0");
		code("return tan(2.5)").almost(Math.tan(2.5));
		code("return tan(PI)").almost(0.0);
		code("return tan(PI / 4)").almost(1.0);
		code("return tan(- PI / 4)").almost(-1.0);
		code("return tan(['', PI / 4][1])").almost(1.0);

		section("Number.asin()");
		code("return asin(0)").equals("0.0");
		code("return asin(-1)").almost(-Math.PI / 2);
		code("return asin(1)").almost(Math.PI / 2);
		// code("return 0.33.asin()").almost(0.33630357515398035);
		code("return asin(['y', -1][1])").almost(-Math.PI / 2);

		section("Number.atan()");
		code("return atan(1)").almost(Math.PI / 4);
		code("return atan(-1)").almost(-Math.PI / 4);
		code("return atan(0.5)").almost(0.463647609000806094);
		// code("return 0.atan()").equals("0");
		code("return atan(['y', 0.5][1])").almost(0.463647609000806094);

		section("Number.atan2()");
		code("return atan2(1, 1)").almost(Math.PI / 4);
		code("return atan2(150.78, 150.78)").almost(Math.PI / 4);
		code("return atan2(1, 0)").almost(Math.PI / 2);
		code("return atan2(-1, 0)").almost(-Math.PI / 2);
		code("return atan2(0, 1)").equals("0.0");
		code("return atan2(0, -1)").almost(Math.PI);
		code("return atan2(12.12, 42.42)").almost(0.278299659005111333);
		...
		code("return atan2(1, 1)").almost(Math.PI / 4);
		code("return atan2(['', -1][1], 1)").almost(-Math.PI / 4);
		code("return atan2(1, ['', -1][1])").almost(3 * Math.PI / 4);
		code("return atan2(['', -1][1], ['', -1][1])").almost(-3 * Math.PI / 4);
		...
		code("return hypot(3, 4)").equals("5.0");
		// code("return 3.hypot(4)").equals("5");
		code("return hypot(34, 74)").almost(81.437092286);
		code("return hypot([34, ''][0], 74)").almost(81.437092286);
		...
		section("Number.sqrt");
		code("return sqrt(2)").almost(Math.sqrt(2));
		...
		code("return sqrt(16)").equals("4.0");
		code("return sqrt(25)").equals("5.0");
		...
		code("return toDegrees(PI)").equals("180.0");
		code("return toDegrees(PI / 2)").equals("90.0");
		code("return toDegrees(-PI / 2)").equals("-90.0");
		code("return toDegrees(0)").equals("0.0");
		...
		code("return toRadians(180)").almost(Math.PI);
		code("return toRadians(90)").almost(Math.PI / 2);
		code("return toRadians(-90)").almost(-Math.PI / 2);
		code("return toRadians(0)").equals("0.0");

		section("Number.log");
		// code("1.log()").equals("0");
		code("return log(1)").equals("0.0");
		code("return log(E)").equals("1.0");
		// code("123456.log()").equals("11.7236400963");
		code("return log(654321)").almost(13.3913533357);
		code("return log([55555, ''][0])").almost(10.9251288);

		section("Number.log10");
		code("return log10(10)").equals("1.0");
		// code("return 1.log10()").equals("0");
		// code("return 123456.log10()").equals("5.0915122016");
		code("return log10(654321)").almost(5.8157908589);
		code("return log10([55555, ''][0])").almost(4.7447231519);

		section("Number.pow");
		// code("2.pow(10)").equals("1024");
		code("return pow(5, 3)").equals("125.0");
		code("return pow(2, 10)").equals("1024.0");
