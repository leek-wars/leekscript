...
public class TestNumber extends TestCommon {
	...
	public void run() throws Exception {
		...
		code_v2("return 15 / 3;").equals("5.0");
		code_v1("return 15 / 2;").equals("7,5");
		code_v2("return 15 / 2;").equals("7.5");
		...
		code_v2("var a = 100 return a /= 5;").equals("20.0");
		...
		code_v2("return (33 - 2) / 2;").equals("15.5");
		...
		code_v2("return 13 / true;").equals("13.0");
		code_v1("return 14 / 2;").equals("7");
		code_v2("return 14 / 2;").equals("7.0");
		code_v1("var a = 18; return a / 3;").equals("6");
		code_v2("var a = 18; return a / 3;").equals("6.0");
		// code("14$ / []").exception(ls::vm::Exception::NO_SUCH_OPERATOR);
		code_v1("var a = 17, b = 5 return a / b;").equals("3,4");
		code_v2("var a = 17, b = 5 return a / b;").equals("3.4");

		section("Number.operator /=");
		code_v1("var a = 12 a /= 3 return a;").equals("4");
		code_v2("var a = 12 a /= 3 return a;").equals("4.0");
		code_v1("var a = 12 a /= 0.5 return a;").equals("24");
		code_v2("var a = 12 a /= 0.5 return a;").equals("24.0");
		code_v1("var a = 12 a /= true return a;").equals("12");
		code_v2("var a = 12 a /= true return a;").equals("12.0");
		code_v1("var a = null a /= 5 return a;").equals("0");
		code_v2("var a = null a /= 5 return a;").equals("0.0");
		...
		code_v2("var a = 15; return ['', a /= 2];").equals("[, 7.5]");
		...
		code_v2("var a = 87619 return a ^= 18431;").equals("70076");
		code_v2("var a = 87619 a ^= 18431 return a;").equals("70076");
		...
		*/
		...
		code_v2("return exp(0)").equals("1.0");
		code_v1("return exp(1)").equals("2,718");
		code_v2("return exp(1)").almost(Math.E);
		code_v1("return exp(4)").equals("54,598");
		code_v2("return exp(4)").almost(54.598150033144236204);
		code_v1("return exp(4.89)").equals("132,954");
		code_v2("return exp(4.89)").almost(132.953574051282743085);
		code_v1("return exp(-2.97)").equals("0,051");
		code_v2("return exp(-2.97)").almost(0.051303310331919108);
		code_v1("return exp(['a', 7.78][1])").equals("2 392,275");
		code_v2("return exp(['a', 7.78][1])").almost(2392.274820537377763685);
		...
		code_v2("return E ** 5;").almost(148.413159102576571513);
		...
		code_v2("return max(5.0, 12);").equals("12.0");
		code_v1("return max(75.7, 12);").equals("75,7");
		code_v2("return max(75.7, 12);").almost(75.7);
		code_v1("return max(5, 12.451);").equals("12,451");
		code_v2("return max(5, 12.451);").almost(12.451);
		...
		code_v2("return max(5, 12.8);").equals("12.8");
		code_v1("return max(15.7, 12.8);").equals("15,7");
		code_v2("return max(15.7, 12.8);").equals("15.7");
		code_v1("return max([15.7, ''][0], 12.8);").equals("15,7");
		code_v2("return max([15.7, ''][0], 12.8);").equals("15.7");
		code_v1("return max(5.5, [12.8, ''][0]);").equals("12,8");
		code_v2("return max(5.5, [12.8, ''][0]);").equals("12.8");
		...
		code_v2("return min(75.7, 12)").almost(12.0);
		code_v1("return min(5, 12.451)").equals("5");
		code_v2("return min(5, 12.451)").almost(5.0);
		...
		code_v2("return min(5, 12.8)").equals("5.0");
		code_v1("return min(15.7, 12.8)").equals("12,8");
		code_v2("return min(15.7, 12.8)").equals("12.8");
		code_v1("return min([15.7, ''][0], 12.8)").equals("12,8");
		code_v2("return min([15.7, ''][0], 12.8)").equals("12.8");
		code_v1("return min(5.5, [12.8, ''][0])").equals("5,5");
		code_v2("return min(5.5, [12.8, ''][0])").equals("5.5");
		...
		code_v2("return atan2(['', -1][1], 1)").almost(-Math.PI / 4);
		code_v1("return atan2(1, ['', -1][1])").equals("2,356");
		code_v2("return atan2(1, ['', -1][1])").almost(3 * Math.PI / 4);
		code_v1("return atan2(['', -1][1], ['', -1][1])").equals("-2,356");
		code_v2("return atan2(['', -1][1], ['', -1][1])").almost(-3 * Math.PI / 4);
		...
		code_v2("return hypot(3, 4)").equals("5.0");
		// code("return 3.hypot(4)").equals("5");
		code_v1("return hypot(34, 74)").equals("81,437");
		code_v2("return hypot(34, 74)").almost(81.437092286);
		code_v1("return hypot([34, ''][0], 74)").equals("81,437");
		code_v2("return hypot([34, ''][0], 74)").almost(81.437092286);
		...
		code_v2("return sqrt(2)").almost(Math.sqrt(2));
		...
		code_v2("return sqrt(16)").equals("4.0");
		code_v1("return sqrt(25)").equals("5");
		code_v2("return sqrt(25)").equals("5.0");
		...
		code_v2("return toDegrees(PI)").equals("180.0");
		code_v1("return toDegrees(PI / 2)").equals("90");
		code_v2("return toDegrees(PI / 2)").equals("90.0");
		code_v1("return toDegrees(-PI / 2)").equals("-90");
		code_v2("return toDegrees(-PI / 2)").equals("-90.0");
		code_v1("return toDegrees(0)").equals("0");
		code_v2("return toDegrees(0)").equals("0.0");
