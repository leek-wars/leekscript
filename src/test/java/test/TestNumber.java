...
public class TestNumber extends TestCommon {
	...
	public void run() throws Exception {
		...
		code("return 15 / 3;").equals("5.0");
		code("return 15 / 2;").equals("7.5");
		...
		code("return 13 / true;").equals("13");
		code("return 14 / 2;").equals("7.0");
		code("var a = 18; return a / 3;").equals("6.0");
		// code("14$ / []").exception(ls::vm::Exception::NO_SUCH_OPERATOR);
		code("var a = 17, b = 5 return a / b;").equals("3.4");

		section("Number.operator /=");
		code("var a = 12 a /= 3 return a;").equals("4.0");
		code("var a = 12 a /= 0.5 return a;").equals("24.0");
		code("var a = 12 a /= true return a;").equals("12");
		code("var a = null a /= 5 return a;").equals("0");
		...
		*/
		...
		code("return abs(-19.5);").equals("19.5");
		code("return abs(12);").equals("12");
		// code("return abs(-16436435l)").equals("16436435");
		code("return abs(-12.67);").almost(12.67);
		...
		section("Number.exp()");
		code("return exp(0)").equals("1.0");
		code("return exp(1)").almost(Math.E);
		code("return exp(4)").almost(54.598150033144236204);
		code("return exp(4.89)").almost(132.953574051282743085);
		code("return exp(-2.97)").almost(0.051303310331919108);
		code("return exp(['a', 7.78][1])").almost(2392.274820537377763685);
		...
		code("return E ** 5;").almost(148.413159102576571513);
