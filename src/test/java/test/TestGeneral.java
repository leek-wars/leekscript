...
public class TestGeneral extends TestCommon {
	...
	public void run() {
		...
		DISABLED_code("real a = 1.1 integer b = a return b").equals("1");
		DISABLED_code("real a = 1.9 integer b = a return b").equals("1");
		DISABLED_code("integer|real a = 1.999; integer b = a; return b").equals("1");
	}
}
