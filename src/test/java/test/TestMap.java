...
public class TestMap extends TestCommon {
	...
	public void run() {
		...
		*/
		...
		code_v10("var m = [5: 12.5] return m[5]").equals("12,5");
		code_v11("var m = [5: 12.5] return m[5]").equals("12.5");
		code("var m = [5.5: 12] return m[5.5]").equals("12");
		code_v10("var m = [5.5: 12.5] return m[5.5]").equals("12,5");
		code_v11("var m = [5.5: 12.5] return m[5.5]").equals("12.5");
		code("var m = ['salut': 12] return m['salut']").equals("12");
		code_v10("var m = ['salut': 12.5] return m['salut']").equals("12,5");
		code_v11("var m = ['salut': 12.5] return m['salut']").equals("12.5");
		...
		code_v10("var m = ['a': 2.5, 'b': 4.8] m['c'] = 6.9 return m").equals("[a : 2,5, b : 4,8, c : 6,9]");
		code_v11("var m = ['a': 2.5, 'b': 4.8] m['c'] = 6.9 return m").equals("[a : 2.5, b : 4.8, c : 6.9]");
		code("var m = [1: 'a', 2: 'b'] m[3] = 'c' return m").equals("[1 : a, 2 : b, 3 : c]");
		code("var m = ['a': '2', 'b': '4'] m['c'] = '6' return m").equals("[a : 2, b : 4, c : 6]");
		code("var m = [1: 2, 3: 4] m[3] = 6 return m").equals("[1 : 2, 3 : 6]");
		code_v10("var m = [1: 2.5, 3: 4.5] m[3] = 6.5 return m").equals("[1 : 2,5, 3 : 6,5]");
		code_v11("var m = [1: 2.5, 3: 4.5] m[3] = 6.5 return m").equals("[1 : 2.5, 3 : 6.5]");
		// code_v10("var m = [1.5: 2, 3.5: 4] m[3.5] = 6 return m").equals("[1,5 : 2, 3,5 : 6]");
		// code_v11("var m = [1.5: 2, 3.5: 4] m[3.5] = 6 return m").equals("[1.5 : 2, 3.5 : 6]");
		// code_v10("var m = [1.5: 2.5, 3.5: 4.5] m[3.5] = 6.5 return m").equals("[1,5 : 2,5, 3,5 : 6,5]");
		// code_v11("var m = [1.5: 2.5, 3.5: 4.5] m[3.5] = 6.5 return m").equals("[1.5 : 2.5, 3.5 : 6.5]");
		code("var m = ['1': 2, '3': 4] m['3'] = 6 return m").equals("[1 : 2, 3 : 6]");
		// code_v10("var m = [1.5: 'a', 2.5: 'b'] m[2.5] = 'c' return m").equals("[1,5 : a, 2,5 : c]");
		// code_v11("var m = [1.5: 'a', 2.5: 'b'] m[2.5] = 'c' return m").equals("[1.5 : a, 2.5 : c]");
