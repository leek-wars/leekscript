...
public class TestMap extends TestCommon {
	...
	public void run() {
		...
		*/
		...
		code_v2("var m = ['a': 2.5, 'b': 4.8] m['c'] = 6.9 return m").equals("[a : 2.5, b : 4.8, c : 6.9]");
		...
		code_v2("var m = [1: 2.5, 3: 4.5] m[3] = 6.5 return m").equals("[1 : 2.5, 3 : 6.5]");
		// code_v1("var m = [1.5: 2, 3.5: 4] m[3.5] = 6 return m").equals("[1,5 : 2, 3,5 : 6]");
		// code_v2("var m = [1.5: 2, 3.5: 4] m[3.5] = 6 return m").equals("[1.5 : 2, 3.5 : 6]");
		// code_v1("var m = [1.5: 2.5, 3.5: 4.5] m[3.5] = 6.5 return m").equals("[1,5 : 2,5, 3,5 : 6,5]");
		// code_v2("var m = [1.5: 2.5, 3.5: 4.5] m[3.5] = 6.5 return m").equals("[1.5 : 2.5, 3.5 : 6.5]");
		code("var m = ['1': 2, '3': 4] m['3'] = 6 return m").equals("[1 : 2, 3 : 6]");
		// code_v1("var m = [1.5: 'a', 2.5: 'b'] m[2.5] = 'c' return m").equals("[1,5 : a, 2,5 : c]");
		// code_v2("var m = [1.5: 'a', 2.5: 'b'] m[2.5] = 'c' return m").equals("[1.5 : a, 2.5 : c]");
