...
public class TestReference extends TestCommon {
	...
	public void run() throws Exception {
		...
		code_v1("var t = 0; var f = function(a) { t = a }; f([]);").equals("null");
		code_v1("var t = 0; var f = function(a) { t = a }; var b = []; f(b);").equals("null");
		code_v1("var t = 0; var f = function(a) { t = a }; var b = []; f(b); push(t, 5);").equals("null");
		...
		code_v1("var a = 12; var b = @a; a++; return [a, b]").equals("[13, 12]");
		code_v1("var a = 12; var b = @a; var c = @b; a++; return [a, b, c]").equals("[13, 12, 12]");
		code_v1("var a = [12]; var b = @a[0]; a[0]++; return [a, b]").equals("[[13], 12]");
		code_v1("var a = @[1, 2, 3]; var b = @a; (@(b));").equals("null");
		code_v1("var a = @[1, 2, 3]; var b = @a; return (@(b));").equals("[1, 2, 3]");
	}
}
