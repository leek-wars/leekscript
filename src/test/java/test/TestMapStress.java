...
public class TestMapStress extends TestCommon {
	...
	public void run() throws Exception {
		...
		code_v4_("var all = [] for (var j = 0; j < 20; ++j) { var a = [:] for (var i = 0; i < 100000; ++i) a[i] = 1 push(all, a) } return count(all)").error(Error.OUT_OF_MEMORY);
		code_v4_("for (var j = 0; j < 20; ++j) { var a = [:] for (var i = 0; i < 100000; ++i) a[i] = 1 } return 'ok'").equals("\"ok\"");
