...
public class TestFiles extends TestCommon {
	...
	public void run() {
		...
		header("Files");
		section("General");
		file_v11("ai/code/primes.leek").equals("78498");
		...
		file_v11("ai/code/two_functions.leek").equals("[{p: 2, v: 5}, [{p: 3, v: 6}]]");
		...
		file_v11("ai/code/fold_left.leek").equals("[{w: 1}, {w: 3}, {w: 4}, {w: 2}, {w: 7}, {w: 5}, {w: 8}, {w: 9}, {w: 6}]");
		...
		file_v11("ai/code/classes_simple.leek").equals("[Ferrari, Maserati, Lamborghini]");
		file_v11("ai/code/classes_multiple.leek").equals("[4, 40, 80]");
